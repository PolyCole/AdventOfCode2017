...
<p>Your puzzle answer was <code>53978</code>.</p><article class="day-desc"><h2>--- Part Two ---</h2><p>"Great work; looks like we're on the right track after all.  Here's a <em class="star">star</em> for your effort." However, the program seems a little worried. Can programs <em>be</em> worried?</p>
